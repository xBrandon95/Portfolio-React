        ...
        <div className="row items-center">
          ...
          <div className="about-info">
            <p>
              ...
              nunc mauris, facilisis finibus tempus vitae, laoreet non diam.
              Orci varius natoque penatibus et magnis dis parturient montes,
              nascetur ridiculus mus. Vivamus faucibus mi ante, nec rhoncus odio
              fringilla sed. Mauris in diam et tellus rhoncus porta. Nulla
              bibendum, odio in facilisis ultricies, elit leo porta purus, sed
            </p>
            <p>
              Iaculis odio urna ac est. Vestibulum ante ipsum primis in faucibus
              orci luctus et ultrices posuere cubilia curae; Praesent gravida mi
              ac suscipit pellentesque. Nullam hendrerit ornare erat, vitae
              dictum metus sodales vel. Mauris vitae ipsum dolor.
            </p>
